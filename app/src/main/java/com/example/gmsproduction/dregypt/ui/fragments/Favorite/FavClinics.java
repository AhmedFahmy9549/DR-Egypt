...
public class FavClinics extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_favorite_clinics, container, false);
        SharedPreferences prefs = getActivity().getSharedPreferences(Constants.USER_DETAILS, MODE_PRIVATE);
        userid = prefs.getInt("User_id", 0);
        mRecyclerView = rootView.findViewById(R.id.FavClin_RecycleView);
        DisplayFav();
        return rootView;
    }

    private void DisplayFav() {
        final DisplayClinFavoriteByID disp = new DisplayClinFavoriteByID(getContext(), userid, new Response.Listener<String>() {
            @Override
