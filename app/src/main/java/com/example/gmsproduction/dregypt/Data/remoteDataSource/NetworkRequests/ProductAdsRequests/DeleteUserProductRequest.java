...
public class DeleteUserProductRequest {

    VolleyLIbUtils volleyLIbUtils;
    String url;
    int methodId;

    public DeleteUserProductRequest(Context context, int user_id, int id, Response.Listener<String> listener, Response.ErrorListener errorListener){
    ...
    private void setValues(int user_id,int id){
        url= Constants.basicUrl+"/users/"+user_id+"/product-ads/"+id;
