...
public class AdapterLocationClinicRecylcer extends RecyclerView.Adapter<AdapterLocationClinicRecylcer.Myholder> {
    ...
    public AdapterLocationClinicRecylcer(Context context, ArrayList<LocationModel> arrayList, int id) {
